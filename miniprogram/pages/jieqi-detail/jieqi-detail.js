...
const JIEQI_TIPS = {
  ...
  bailu: ['清润润肺：清润沙参茶包早晚一杯', '润肺下气：祁紫菀超细药用粉冲服', '健鼻：晨起按迎香穴'],
  qiufen: ['清肝明目：单味祁菊花茶包温水现冲', '团圆礼赠：亲民礼盒送中秋佳节', '尊贵馈赠：商务礼盒走访客户'],
  hanlu: ['温养脾胃：即食薏米代餐糕配热粥', '润肺下气：祁紫菀超细药用粉冲服', '足部保暖：足寒则全身寒'],
